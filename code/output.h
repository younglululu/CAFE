...
public:
	...
	void writeToFile(OUTPUT_TYPE arg_output_type, smat::Matrix<double>* arg_distMat, std::vector<std::string>* arg_nameVec, std::string str_arg_outputFileURL);
	void writeToConsole(OUTPUT_TYPE arg_output_type, smat::Matrix<double>* arg_distMat, std::vector<std::string>* arg_nameVec);
